var homeService = (function() {
  ...
  var listCourses = function(courses) {
    ...
    html += "<div class='card-head'><small class='curs-title'>FRONTEND INITIERE</small><span class='price'>379 EUR<sub>/4 luni</sub></span></div><div class='course-image-container'></div><ul class='list-group list-group-flush'><div class='list-group-item'>Foloseste Html5, Css3, Java-script, JQuery, GIT si invata cum sa construiesti un website de la zero.</div></ul><div class='card-body'><a href='screens/curs.html' class='btn btn-course btn-lg btn-block'>Vezi detalii</a></div>"
    });
    html += "</div>";
    return html;
  };
